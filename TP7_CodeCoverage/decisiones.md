...
# CRÍTICO: Exclusiones para evitar falsos positivos
...
module.exports = defineConfig({
  e2e: {
    // CRÍTICO: baseUrl DEBE ser configurable
...
### Problema 2: Tests lentos en Pipeline
...
| Frontend | ~40% | En desarrollo | Pendiente |
